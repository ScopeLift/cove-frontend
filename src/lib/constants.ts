import { arbitrum, gnosis, goerli, mainnet, optimism, polygon, sepolia, avalanche } from 'viem/chains';
...
export const GITHUB_URL = 'https://github.com/ScopeLift/cove-backend';
export const TWITTER_URL = 'https://twitter.com/ScopeLift';

export const IS_DEV_MODE = process.env.NODE_ENV === 'development';

export const SUPPORTED_CHAINS = { arbitrum, gnosis, goerli, mainnet, optimism, polygon, sepolia, avalanche };
